...
| --- | --- | --- | --- |
| `reference` | string | Yes | The unique reference you passed when initiating the transfer |
| `session_id` | string | Yes | The session ID returned in the initial transfer response |
