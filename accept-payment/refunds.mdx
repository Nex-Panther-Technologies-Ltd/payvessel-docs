...
<CardGroup cols={2}>
  <Card title="✈️ Travel & Hospitality" icon="plane">
...
<CardGroup cols={2}>
  ...
  <Card title="🤝 Customer Experience" icon="handshake">
