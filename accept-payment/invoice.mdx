...
<CardGroup cols={2}>
  <Card title="📄 Professional Invoices" icon="file-invoice">
    Branded invoices with itemized billing
  </Card>
  <Card title="⚡ Auto-Collection" icon="bolt">
...
<CardGroup cols={3}>
  ...
  <Card title="💰 Faster Payments" icon="money-bill">
...
<CardGroup cols={2}>
  <Card title="🏪 Wholesale" icon="boxes">
    - Bulk order invoicing
    - Net payment terms
    - Volume discount calculations
    - Credit limit management
  </Card>
  <Card title="🚚 B2B Services" icon="truck">
...
<CardGroup cols={2}>
  ...
  <Card title="⏱️ Efficiency Metrics" icon="clock">
...
<CardGroup cols={2}>
  ...
  <Card title="💬 Communication Tips" icon="comments">
    - Clear payment terms
...
<CardGroup cols={2}>
  <Card title="🚀 Start Creating" icon="rocket" href="/api-reference/endpoint/create">
