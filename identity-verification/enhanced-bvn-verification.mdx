---
title: "BVN Verification API (Enhanced)"
description: "PayVessel enhanced BVN verification API returns full BVN profile data for Nigerian KYC and onboarding workflows."
keywords:
  [
    "BVN verification API",
    "enhanced BVN API",
    "BVN lookup API Nigeria",
    "PayVessel BVN",
  ]
sidebarTitle: "Enhanced BVN Verification"
---
