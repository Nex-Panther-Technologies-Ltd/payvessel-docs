---
title: "NIN Verification API (Enhanced)"
description: "PayVessel enhanced NIN verification API returns extended NIN profile data for Nigerian identity verification."
keywords:
  [
    "NIN verification API",
    "enhanced NIN API",
    "NIN lookup API Nigeria",
    "PayVessel NIN",
  ]
sidebarTitle: "Enhanced NIN Verification"
---
