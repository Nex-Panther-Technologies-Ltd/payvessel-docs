...
curl -X POST https://sandbox.payvessel.com/pms/transactions/initialize/ \
  ...
  -d '{
    ...
    "metadata": {
        "source": "payvessel_test_platform",
        "platform": "web"
    }
}'
```
...
```json 200 Success
{
  ...
  "data": {
    ...
    "transaction_ref": "AEEB469A686141D28C0D361E9FE0250F",
    "amount": "5000.00",
    "status": "PENDING",
    "access_code": "ACS-I77VVH-EROP40XN-TCGOTP-XCN4",
    "checkout_url": "https://checkout.payvessel.com/ACS-I77VVH-EROP40XN-TCGOTP-XCN4",
