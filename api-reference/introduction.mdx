---
title: "API Reference"
description: "PayVessel REST API reference for virtual card API, virtual account API, BVN and NIN verification API, credit score API, payments, transfers, and wallets."
keywords:
  [
