...
<Note>
**Documentation status:** Card payment and Merchant Checkout are documented with production-ready examples. Payouts (External Dedicated Wallet) and some other sections link to the [PMS Swagger](https://api.payvessel.com/pms/api/docs/swagger/) for full request/response details. If a section is unclear or missing, [contact support](mailto:support@payvessel.com).
</Note>
