...
Idempotency is crucial for payment processing to ensure that retrying a request doesn't create duplicate charges or unintended side effects.

<CardGroup cols={2}>
  <Card title="🔄 Safe Retries" icon="rotate">
    Retry failed requests without creating duplicates
  </Card>
  <Card title="🛡️ Duplicate Protection" icon="shield-check">
