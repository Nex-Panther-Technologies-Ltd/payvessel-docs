...
<Frame caption="Card details — balance, funding, lifecycle controls, and transaction history">
  <img
    src="/images/virtual-cards/card-details-dashboard.jpg"
    alt="PayVessel merchant dashboard card details page with balance, fund and withdraw actions, virtual card preview, freeze toggle, and transactions table"
