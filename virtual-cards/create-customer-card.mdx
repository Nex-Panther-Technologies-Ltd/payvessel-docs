...
5. **Manage the card** in the [merchant dashboard](/virtual-cards/overview#merchant-dashboard-card-details) (fund, withdraw, freeze, transactions) or through the API endpoints below.

<Frame caption="Card details after issuance — merchant dashboard">
  <img
    src="/images/virtual-cards/card-details-dashboard.jpg"
    alt="PayVessel card details page showing $10 balance, fund and withdraw buttons, and Card prefund transaction rows"
