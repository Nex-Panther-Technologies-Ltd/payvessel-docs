...
description: "Retrieve Nigerian virtual account details by ID using the PayVessel virtual account API."
keywords: ["virtual account API", "get virtual account", "PayVessel virtual account"]
---
